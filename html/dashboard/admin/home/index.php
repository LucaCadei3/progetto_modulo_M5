...
<hmtl>
    ...
    <body>
        ...
        <section class="header">
            ...
            <nav class="navbar">
                <a href="account/logout/index.php">Logout</a>
            </nav>
        </section>
        <section class="home" id="home">
            <center>
            <h1 style="font-size: 36px; margin-top: 50px;">Area riservata</h1>
                <div class="divAreaRis">
                    <table style="margin-left: 20px; margin-rigth: 20px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Visualizza le recensioni del ristorante</p>
                            </td>
                        </tr>
                    </table>
                </div>
